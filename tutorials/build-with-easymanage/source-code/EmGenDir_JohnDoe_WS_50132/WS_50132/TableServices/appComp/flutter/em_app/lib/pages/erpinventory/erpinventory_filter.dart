...
class ErpInventoryFilter extends StatefulWidget { 
  const ErpInventoryFilter({Key? key}) : super(key: key); 
 
  @override 
  _ErpInventoryFilterState createState() => _ErpInventoryFilterState(); 
} 
 
class _ErpInventoryFilterState extends State<ErpInventoryFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            ErpInventoryDataTable(viewType: "ListView", 
                                            pageNo: 0, 

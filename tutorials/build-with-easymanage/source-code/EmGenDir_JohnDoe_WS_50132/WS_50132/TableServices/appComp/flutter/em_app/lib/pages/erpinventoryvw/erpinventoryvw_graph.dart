...
class ErpInventoryVwGraph extends StatefulWidget { 	
  const ErpInventoryVwGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _ErpInventoryVwGraphState createState() => _ErpInventoryVwGraphState(); 	
} 	
	 	
class _ErpInventoryVwGraphState extends State<ErpInventoryVwGraph> { 	
 	
  //List<ErpInventoryVw> erpInventoryVwList = []; 	
  List<EmChartModel> erpInventoryVwList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //ErpInventoryVwService.ErpInventoryVwViewAll().then((getList) { 	
    setState(() { 	
      //erpInventoryVwList = getList; 	
      //Local static data loading 	
      erpInventoryVwList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'ErpInventoryVw Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                erpInventoryVwList: erpInventoryVwList) 	
                            : LineChart(lineChartErpInventoryVw()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartErpInventoryVw() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> erpInventoryVwList; 	
  const BarChartSample2({Key? key, required this.erpInventoryVwList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.erpInventoryVwList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	

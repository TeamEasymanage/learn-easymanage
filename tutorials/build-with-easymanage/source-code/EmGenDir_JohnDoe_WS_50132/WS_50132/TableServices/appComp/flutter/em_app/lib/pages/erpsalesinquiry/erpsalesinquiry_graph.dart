...
class ErpSalesInquiryGraph extends StatefulWidget { 	
  const ErpSalesInquiryGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _ErpSalesInquiryGraphState createState() => _ErpSalesInquiryGraphState(); 	
} 	
	 	
class _ErpSalesInquiryGraphState extends State<ErpSalesInquiryGraph> { 	
 	
  //List<ErpSalesInquiry> erpSalesInquiryList = []; 	
  List<EmChartModel> erpSalesInquiryList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //ErpSalesInquiryService.ErpSalesInquiryViewAll().then((getList) { 	
    setState(() { 	
      //erpSalesInquiryList = getList; 	
      //Local static data loading 	
      erpSalesInquiryList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'ErpSalesInquiry Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                erpSalesInquiryList: erpSalesInquiryList) 	
                            : LineChart(lineChartErpSalesInquiry()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartErpSalesInquiry() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> erpSalesInquiryList; 	
  const BarChartSample2({Key? key, required this.erpSalesInquiryList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.erpSalesInquiryList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	

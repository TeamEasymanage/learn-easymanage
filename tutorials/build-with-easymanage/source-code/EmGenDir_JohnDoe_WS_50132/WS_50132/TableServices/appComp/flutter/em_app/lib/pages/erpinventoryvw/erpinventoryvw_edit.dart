...
class ErpInventoryVwEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int invIdSelected; 
  const ErpInventoryVwEdit({Key? key, required this.invIdSelected}) : super(key: key); 
 
  @override 
  _ErpInventoryVwEditState createState() => _ErpInventoryVwEditState(); 
} 
 
class _ErpInventoryVwEditState extends State<ErpInventoryVwEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ErpInventoryVw Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class ErpInventoryVwEditRec extends StatefulWidget { 
  final ErpInventoryVw erpInventoryVw; 
  const ErpInventoryVwEditRec({Key? key, required this.erpInventoryVw}) : super(key: key); 
 
  @override 
  _ErpInventoryVwEditRecState createState() => _ErpInventoryVwEditRecState(); 
} 
 
class _ErpInventoryVwEditRecState extends State<ErpInventoryVwEditRec> { 

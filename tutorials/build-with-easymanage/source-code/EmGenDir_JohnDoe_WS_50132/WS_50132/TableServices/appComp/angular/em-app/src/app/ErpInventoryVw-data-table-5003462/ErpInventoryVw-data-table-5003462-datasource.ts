...
// Data model type 
export interface ErpInventoryVwItem { 
...
//const EXAMPLE_DATA: ErpInventoryVwItem[] = []; 
 
/** 
 * Data source for the ErpInventoryVw view. This class should 
 * encapsulate all logic for fetching and manipulating the displayed data 
 * (including sorting, pagination, and filtering). 
 */ 
export class ErpInventoryVwDataSource extends DataSource<ErpInventoryVwItem> { 
  //data: ErpInventoryVwItem[] = EXAMPLE_DATA; 
  data: Array<any> = []; 
   ...
   */ 
  connect(): Observable<ErpInventoryVwItem[]> { 
   ...
   */ 
  private getPagedData(data: ErpInventoryVwItem[]): ErpInventoryVwItem[] { 
    if (this.paginator) { 
   ...
   * this would be replaced by requesting the appropriate data from the server. 
   */ 
  private getSortedData(data: ErpInventoryVwItem[]): ErpInventoryVwItem[] { 

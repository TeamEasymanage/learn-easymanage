...
// Data model type 
export interface ErpCustomerItem { 
...
//const EXAMPLE_DATA: ErpCustomerItem[] = []; 
 
/** 
 * Data source for the ErpCustomer view. This class should 
 * encapsulate all logic for fetching and manipulating the displayed data 
 * (including sorting, pagination, and filtering). 
 */ 
export class ErpCustomerDataSource extends DataSource<ErpCustomerItem> { 
  //data: ErpCustomerItem[] = EXAMPLE_DATA; 
  data: Array<any> = []; 
   ...
   */ 
  connect(): Observable<ErpCustomerItem[]> { 
   ...
   */ 
  private getPagedData(data: ErpCustomerItem[]): ErpCustomerItem[] { 
    if (this.paginator) { 
   ...
   * this would be replaced by requesting the appropriate data from the server. 
   */ 
  private getSortedData(data: ErpCustomerItem[]): ErpCustomerItem[] { 
    ...
    return data.sort((a, b) => { 
      ...
      switch (this.sort?.active) { 
		...
		case 'mobilePhone': return compare(a.mobilePhone, b.mobilePhone,isAsc); 
		case 'pict': return compare(a.pict, b.pict,isAsc); 

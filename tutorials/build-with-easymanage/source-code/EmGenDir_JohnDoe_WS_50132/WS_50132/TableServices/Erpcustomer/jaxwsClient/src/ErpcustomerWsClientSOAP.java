...
public class ErpcustomerWsClientSOAP { 
 
	public static void main(String[] args) { 
		try { 
			ErpcustomerWsClientSOAP sc = new ErpcustomerWsClientSOAP(); 
		...
		URL endpoint = new URL ("http://localhost:8080/ErpcustomerWsJaxm/ErpcustomerWsJaxmService"); 
		...
		System.out.println("End. [ErpcustomerWsJaxm calls] "); 
...
private Document getDocument() { 
	...
	try { 
            ...
            JAXBElement<?> poElement = (JAXBElement<?>)u.unmarshal( new FileInputStream( "./../jaxb/ErpcustomerWs.xml" ) ); 

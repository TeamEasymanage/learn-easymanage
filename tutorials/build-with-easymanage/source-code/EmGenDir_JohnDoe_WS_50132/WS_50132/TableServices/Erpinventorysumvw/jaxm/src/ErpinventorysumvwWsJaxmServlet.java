package ErpinventorysumvwWs.jaxm;  
...
public class ErpinventorysumvwWsJaxmServlet extends JAXMServlet implements ReqRespListener { 
    ...
    */ 
    public SOAPMessage onMessage(SOAPMessage message) { 
        System.out.println("onMessage() called in ErpinventorysumvwWsJaxm SOAP Service"); 
        String statusMsg = ""; 
        try { 

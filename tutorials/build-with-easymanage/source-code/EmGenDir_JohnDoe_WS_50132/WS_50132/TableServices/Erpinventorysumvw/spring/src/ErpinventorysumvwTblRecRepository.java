...
public interface ErpinventorysumvwTblRecRepository extends JpaRepository<ErpinventorysumvwTblRec, String> /*QD , QuerydslPredicateExecutor<ErpinventorysumvwTblRec> QD*/ { 

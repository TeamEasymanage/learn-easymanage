...
public class ErpinventorysumvwWsClientSOAP { 
 
	public static void main(String[] args) { 
		try { 
			ErpinventorysumvwWsClientSOAP sc = new ErpinventorysumvwWsClientSOAP(); 
		...
		URL endpoint = new URL ("http://localhost:8080/ErpinventorysumvwWsJaxm/ErpinventorysumvwWsJaxmService"); 
		...
		System.out.println("End. [ErpinventorysumvwWsJaxm calls] "); 
...
private Document getDocument() { 
	...
	try { 
            ...
            JAXBElement<?> poElement = (JAXBElement<?>)u.unmarshal( new FileInputStream( "./../jaxb/ErpinventorysumvwWs.xml" ) ); 

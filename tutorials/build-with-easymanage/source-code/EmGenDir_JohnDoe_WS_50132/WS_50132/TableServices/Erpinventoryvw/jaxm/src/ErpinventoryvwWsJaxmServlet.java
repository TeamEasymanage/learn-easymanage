...
public class ErpinventoryvwWsJaxmServlet extends JAXMServlet implements ReqRespListener { 
    ...
    */ 
    public SOAPMessage onMessage(SOAPMessage message) { 
        System.out.println("onMessage() called in ErpinventoryvwWsJaxm SOAP Service"); 
        String statusMsg = ""; 
        try { 

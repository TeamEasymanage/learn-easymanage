...
public interface ErpinventoryvwTblRecRepository extends JpaRepository<ErpinventoryvwTblRec, String> /*QD , QuerydslPredicateExecutor<ErpinventoryvwTblRec> QD*/ { 

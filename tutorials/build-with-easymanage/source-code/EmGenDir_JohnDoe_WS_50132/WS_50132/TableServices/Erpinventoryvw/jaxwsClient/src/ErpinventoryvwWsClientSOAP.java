...
public class ErpinventoryvwWsClientSOAP { 
 
	public static void main(String[] args) { 
		try { 
			ErpinventoryvwWsClientSOAP sc = new ErpinventoryvwWsClientSOAP(); 
		...
		URL endpoint = new URL ("http://localhost:8080/ErpinventoryvwWsJaxm/ErpinventoryvwWsJaxmService"); 
		...
		System.out.println("End. [ErpinventoryvwWsJaxm calls] "); 
...
private Document getDocument() { 
	...
	try { 
            ...
            JAXBElement<?> poElement = (JAXBElement<?>)u.unmarshal( new FileInputStream( "./../jaxb/ErpinventoryvwWs.xml" ) ); 

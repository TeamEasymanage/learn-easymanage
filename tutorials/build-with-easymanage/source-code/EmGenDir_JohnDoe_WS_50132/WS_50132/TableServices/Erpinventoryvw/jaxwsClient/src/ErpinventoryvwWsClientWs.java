package ErpinventoryvwWsClient;  
...
import ErpinventoryvwWs.service.*; 
 
public class ErpinventoryvwWsClientWs { 
	@WebServiceRef (wsdlLocation="http://localhost:8080/ErpinventoryvwWsService/ErpinventoryvwWsService?wsdl")  
	static ErpinventoryvwWsService service; 
 
	public static void main(String[] args) { 
		try { 
			ErpinventoryvwWsClientWs client = new ErpinventoryvwWsClientWs(); 
			client.doTest(args); 
	...
	public void doTest(String[] args) { 
		try { 
		System.out.println("Retrieving the port from the following service: ErpinventoryvwWs ");  
		ErpinventoryvwWsSvc port = service.getErpinventoryvwWsPort(); 
		...
		System.out.println("Calling ErpinventoryvwformDisplayAll(): [i.e. ErpinventoryvwformDisplayAll] "); 
		ErpinventoryvwForm wsForm1 = port.ErpinventoryvwformDisplayAll(); 

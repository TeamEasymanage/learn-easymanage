package ErpsalesinquiryWs.jaxm;  
...
public class ErpsalesinquiryWsJaxmServlet extends JAXMServlet implements ReqRespListener { 
    ...
    */ 
    public SOAPMessage onMessage(SOAPMessage message) { 
        System.out.println("onMessage() called in ErpsalesinquiryWsJaxm SOAP Service"); 
        String statusMsg = ""; 
        try { 

...
public class ErpsalesinquiryWsClientSOAP { 
 
	public static void main(String[] args) { 
		try { 
			ErpsalesinquiryWsClientSOAP sc = new ErpsalesinquiryWsClientSOAP(); 
		...
		URL endpoint = new URL ("http://localhost:8080/ErpsalesinquiryWsJaxm/ErpsalesinquiryWsJaxmService"); 
		...
		System.out.println("End. [ErpsalesinquiryWsJaxm calls] "); 
...
private Document getDocument() { 
	...
	try { 
            ...
            JAXBElement<?> poElement = (JAXBElement<?>)u.unmarshal( new FileInputStream( "./../jaxb/ErpsalesinquiryWs.xml" ) ); 

...
public class ErpinventoryWsJaxmServlet extends JAXMServlet implements ReqRespListener { 
    ...
    */ 
    public SOAPMessage onMessage(SOAPMessage message) { 
        System.out.println("onMessage() called in ErpinventoryWsJaxm SOAP Service"); 
        String statusMsg = ""; 
        try { 

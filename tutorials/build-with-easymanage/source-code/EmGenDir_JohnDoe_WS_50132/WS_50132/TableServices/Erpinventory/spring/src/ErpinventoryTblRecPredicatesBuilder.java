...
public final class ErpinventoryTblRecPredicatesBuilder { 
 
    EmPredicatesBuilder emBuilder = new EmPredicatesBuilder(); 
 
    public ErpinventoryTblRecPredicatesBuilder (String search) { 
        if (search != null) { 
    ...
    public BooleanExpression build() { 
        ...
        while (param.hasNext()) 
        { 
            ErpinventoryTblRecPredicate predicate = new ErpinventoryTblRecPredicate(param.next()); 

...
public class ErpinventoryWsClientSOAP { 
 
	public static void main(String[] args) { 
		try { 
			ErpinventoryWsClientSOAP sc = new ErpinventoryWsClientSOAP(); 
		...
		URL endpoint = new URL ("http://localhost:8080/ErpinventoryWsJaxm/ErpinventoryWsJaxmService"); 
		...
		System.out.println("End. [ErpinventoryWsJaxm calls] "); 
...
private Document getDocument() { 
	...
	try { 
            ...
            JAXBElement<?> poElement = (JAXBElement<?>)u.unmarshal( new FileInputStream( "./../jaxb/ErpinventoryWs.xml" ) ); 

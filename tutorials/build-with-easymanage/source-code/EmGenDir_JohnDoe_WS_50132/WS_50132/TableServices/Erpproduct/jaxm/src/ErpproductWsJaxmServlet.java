...
public class ErpproductWsJaxmServlet extends JAXMServlet implements ReqRespListener { 
    ...
    */ 
    public SOAPMessage onMessage(SOAPMessage message) { 
        System.out.println("onMessage() called in ErpproductWsJaxm SOAP Service"); 
        String statusMsg = ""; 
        try { 

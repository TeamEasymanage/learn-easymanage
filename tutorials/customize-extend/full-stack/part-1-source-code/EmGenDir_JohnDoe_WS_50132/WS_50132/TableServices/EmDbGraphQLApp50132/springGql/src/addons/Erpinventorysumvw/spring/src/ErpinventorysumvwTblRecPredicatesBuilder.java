...
public final class ErpinventorysumvwTblRecPredicatesBuilder { 
 
    EmPredicatesBuilder emBuilder = new EmPredicatesBuilder(); 
 
    public ErpinventorysumvwTblRecPredicatesBuilder (String search) { 
        if (search != null) { 
    ...
    public BooleanExpression build() { 
        ...
        while (param.hasNext()) 
        { 
            ErpinventorysumvwTblRecPredicate predicate = new ErpinventorysumvwTblRecPredicate(param.next()); 

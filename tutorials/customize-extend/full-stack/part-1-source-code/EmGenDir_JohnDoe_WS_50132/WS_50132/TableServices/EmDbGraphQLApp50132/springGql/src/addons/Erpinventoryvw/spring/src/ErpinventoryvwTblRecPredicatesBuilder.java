...
public final class ErpinventoryvwTblRecPredicatesBuilder { 
 
    EmPredicatesBuilder emBuilder = new EmPredicatesBuilder(); 
 
    public ErpinventoryvwTblRecPredicatesBuilder (String search) { 
        if (search != null) { 
    ...
    public BooleanExpression build() { 
        ...
        while (param.hasNext()) 
        { 
            ErpinventoryvwTblRecPredicate predicate = new ErpinventoryvwTblRecPredicate(param.next()); 

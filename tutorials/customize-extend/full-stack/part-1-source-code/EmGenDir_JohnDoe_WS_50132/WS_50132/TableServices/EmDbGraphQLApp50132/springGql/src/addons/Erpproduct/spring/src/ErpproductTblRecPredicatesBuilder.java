...
public final class ErpproductTblRecPredicatesBuilder { 
 
    EmPredicatesBuilder emBuilder = new EmPredicatesBuilder(); 
 
    public ErpproductTblRecPredicatesBuilder (String search) { 
        if (search != null) { 
    ...
    public BooleanExpression build() { 
        ...
        while (param.hasNext()) 
        { 
            ErpproductTblRecPredicate predicate = new ErpproductTblRecPredicate(param.next()); 

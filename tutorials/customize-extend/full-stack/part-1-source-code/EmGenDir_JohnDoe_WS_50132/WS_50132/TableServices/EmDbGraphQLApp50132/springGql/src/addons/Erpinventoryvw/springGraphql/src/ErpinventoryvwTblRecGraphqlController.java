...
public ErpinventoryvwTblRec ErpinventoryvwTblRecCreate(@Argument("ErpinventoryvwTblRec1") ErpinventoryvwTblRec ErpinventoryvwTblRec1)  
	...
	//ErpinventoryvwTblRec _ErpinventoryvwTblRec = ErpinventoryvwTblRec1Repository
		...
		emrest.spring.ErpproductTblRec ErpproductTblRec1 = new emrest.spring.ErpproductTblRec();

		//ErpproductTblRec1.setProductId(DgproductinventoryviewTblRec1.getProductId());
		ErpproductTblRec1.setProductName(ErpinventoryvwTblRec1.getProductName());

		emrest.spring.ErpproductTblRec _ErpproductTblRec = ErpproductTblRec1Repository
				.saveAndFlush(ErpproductTblRec1);

		//insert to inventory table
		ErpinventoryTblRec ErpinventoryTblRec1 = new ErpinventoryTblRec();
		ErpinventoryTblRec1.setInvId(ErpinventoryvwTblRec1.getInvId());
		ErpinventoryTblRec1.setProductId(ErpproductTblRec1.getProductId());
		ErpinventoryTblRec1.setInvCost(ErpinventoryvwTblRec1.getInvCost());
		ErpinventoryTblRec1.setInvDate(ErpinventoryvwTblRec1.getInvDate());
		ErpinventoryTblRec1.setInvLocation(ErpinventoryvwTblRec1.getInvLocation());
		ErpinventoryTblRec1.setInvMinQty(ErpinventoryvwTblRec1.getInvMinQty());
		ErpinventoryTblRec1.setInvQty(ErpinventoryvwTblRec1.getInvQty());

		ErpinventoryTblRec _ErpinventoryTblRec = ErpinventoryTblRec1Repository
				.save(ErpinventoryTblRec1);

		ErpinventoryvwTblRec1.setProductId(ErpproductTblRec1.getProductId());

		return ErpinventoryvwTblRec1;

...
class ErpCustomerEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String customerIdSelected; 
  const ErpCustomerEdit({Key? key, required this.customerIdSelected}) : super(key: key); 
 
  @override 
  _ErpCustomerEditState createState() => _ErpCustomerEditState(); 
} 
 
class _ErpCustomerEditState extends State<ErpCustomerEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ErpCustomer Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class ErpCustomerEditRec extends StatefulWidget { 
  final ErpCustomer erpCustomer; 
  const ErpCustomerEditRec({Key? key, required this.erpCustomer}) : super(key: key); 
 
  @override 
  _ErpCustomerEditRecState createState() => _ErpCustomerEditRecState(); 
} 
 
class _ErpCustomerEditRecState extends State<ErpCustomerEditRec> { 

...
class ErpInventoryVwOnlyDd extends StatefulWidget { 
  const ErpInventoryVwOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _ErpInventoryVwOnlyDdState createState() => _ErpInventoryVwOnlyDdState(); 
} 
 
class _ErpInventoryVwOnlyDdState extends State<ErpInventoryVwOnlyDd> { 
    ...
    ErpInventoryVwService.ErpInventoryVwViewAll( 	
      ...
      setState(() { 	
       erpInventoryVwList = getList; 	
		invIdSelected = erpInventoryVwList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //erpInventoryVwList = erpInventoryVwList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class ErpInventoryVwEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int invIdSelected; 
  const ErpInventoryVwEditDd({Key? key, required this.invIdSelected}) : super(key: key); 
 
  @override 
  _ErpInventoryVwEditDdState createState() => _ErpInventoryVwEditDdState(); 
} 
 
class _ErpInventoryVwEditDdState extends State<ErpInventoryVwEditDd> { 
  ...
  List<String> _invIds = ["Select A Key Value"]; 	
  ...
  void initState() {	
    ...
    _chosenValue = widget.invIdSelected.toString();	
    _loading = true;	
	
    ErpInventoryVwService.ErpInventoryVwViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
      ...
      setState(() { 	
        ...
        _invIds.insert(0, "0");	
        _invIds.insert(0, "Select A Key Value");	
		 //Remove duplicates 	
        _invIds = _invIds.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("ErpInventoryVw Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<ErpInventoryVw>( 	
                              future: ErpInventoryVwService 	
                                      .ErpInventoryVwQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return ErpInventoryVwEditDdRec( 	
                                          erpInventoryVw: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class ErpInventoryVwEditDdRec extends StatefulWidget { 
  final ErpInventoryVw erpInventoryVw; 
  const ErpInventoryVwEditDdRec({Key? key, required this.erpInventoryVw}) : super(key: key); 
 
  @override 
  _ErpInventoryVwEditDdRecState createState() => _ErpInventoryVwEditDdRecState(); 
} 
 
class _ErpInventoryVwEditDdRecState extends State<ErpInventoryVwEditDdRec> { 
  ErpInventoryVw foundErpInventoryVw = ErpInventoryVw(invId: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundErpInventoryVw = widget.erpInventoryVw; 
			      _textEditingController4.text = getEmStrOpt(foundErpInventoryVw.invDate); 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundErpInventoryVw.invId.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventoryVw.productId.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventoryVw.productName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController4,  
					    //IS-PICKER  initialValue: getEmStrOpt(foundErpInventoryVw.invDate),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventoryVw.invQty.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventoryVw.invMinQty.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventoryVw.invCost.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventoryVw.invLocation),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
					   ...
					   invLocation: invLocationVar , 
                          ...
                          await ErpInventoryVwService.ErpInventoryVwEdit( 
                                  newErpInventoryVw.invId, 
                                  newErpInventoryVw) 
                              .then((message) { 
                                    apiMessage = message; 

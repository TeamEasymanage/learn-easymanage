...
class ErpInventoryVwFilter extends StatefulWidget { 
  const ErpInventoryVwFilter({Key? key}) : super(key: key); 
 
  @override 
  _ErpInventoryVwFilterState createState() => _ErpInventoryVwFilterState(); 
} 
 
class _ErpInventoryVwFilterState extends State<ErpInventoryVwFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Inv Date", 'invDate', 'DATE'],  
		["Inv Qty", 'invQty', 'NUMBER'],  
		["Inv Min Qty", 'invMinQty', 'NUMBER'],  
		["Inv Cost", 'invCost', 'FLOAT'],  
		["Inv Location", 'invLocation', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            ErpInventoryVwDataTable(viewType: "ListView", 
                                            pageNo: 0, 

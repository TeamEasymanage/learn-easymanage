...
class ErpProductForm extends StatefulWidget { 
  const ErpProductForm({Key? key}) : super(key: key); 
 
  @override 
  _ErpProductFormState createState() => _ErpProductFormState(); 
} 
 
class _ErpProductFormState extends State<ErpProductForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("ErpProduct Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newErpProduct creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model ErpProductWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          ErpProductWoKey newErpProduct = ErpProductWoKey( 
 ...
 */ 
					   ...
					   // productPicture: productPictureVar , 
                          ...
                          await ErpProductService.ErpProductCreate( 
                                  newErpProduct.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 

...
class ErpCustomerGraph extends StatefulWidget { 	
  const ErpCustomerGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _ErpCustomerGraphState createState() => _ErpCustomerGraphState(); 	
} 	
	 	
class _ErpCustomerGraphState extends State<ErpCustomerGraph> { 	
 	
  //List<ErpCustomer> erpCustomerList = []; 	
  List<EmChartModel> erpCustomerList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //ErpCustomerService.ErpCustomerViewAll().then((getList) { 	
    setState(() { 	
      //erpCustomerList = getList; 	
      //Local static data loading 	
      erpCustomerList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'ErpCustomer Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                erpCustomerList: erpCustomerList) 	
                            : LineChart(lineChartErpCustomer()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartErpCustomer() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> erpCustomerList; 	
  const BarChartSample2({Key? key, required this.erpCustomerList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.erpCustomerList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	

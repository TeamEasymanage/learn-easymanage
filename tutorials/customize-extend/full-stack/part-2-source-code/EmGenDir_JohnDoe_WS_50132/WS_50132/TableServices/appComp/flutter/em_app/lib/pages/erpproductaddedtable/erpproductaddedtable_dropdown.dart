...
class ErpProductAddedTableOnlyDd extends StatefulWidget { 
  const ErpProductAddedTableOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _ErpProductAddedTableOnlyDdState createState() => _ErpProductAddedTableOnlyDdState(); 
} 
 
class _ErpProductAddedTableOnlyDdState extends State<ErpProductAddedTableOnlyDd> { 
    ...
    ErpProductAddedTableService.ErpProductAddedTableViewAll( 	
      ...
      setState(() { 	
       erpProductAddedTableList = getList; 	
		productIdSelected = erpProductAddedTableList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //erpProductAddedTableList = erpProductAddedTableList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
                                  ...
                                  children: [	
                                    ...
                                    DropdownButton<String>(	
                                      ...
                                      style: const TextStyle(	
                                          ...
                                          color: Colors.black),	
                                      items: erpProductAddedTableList	
...
class ErpProductAddedTableEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int productIdSelected; 
  const ErpProductAddedTableEditDd({Key? key, required this.productIdSelected}) : super(key: key); 
 
  @override 
  _ErpProductAddedTableEditDdState createState() => _ErpProductAddedTableEditDdState(); 
} 
 
class _ErpProductAddedTableEditDdState extends State<ErpProductAddedTableEditDd> { 
  ...
  void initState() {	
    ...
    ErpProductAddedTableService.ErpProductAddedTableViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("ErpProductAddedTable Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                    ...
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<ErpProductAddedTable>( 	
                              future: ErpProductAddedTableService 	
                                      .ErpProductAddedTableQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return ErpProductAddedTableEditDdRec( 	
                                          erpProductAddedTable: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class ErpProductAddedTableEditDdRec extends StatefulWidget { 
  final ErpProductAddedTable erpProductAddedTable; 
  const ErpProductAddedTableEditDdRec({Key? key, required this.erpProductAddedTable}) : super(key: key); 
 
  @override 
  _ErpProductAddedTableEditDdRecState createState() => _ErpProductAddedTableEditDdRecState(); 
} 
 
class _ErpProductAddedTableEditDdRecState extends State<ErpProductAddedTableEditDdRec> { 
  ErpProductAddedTable foundErpProductAddedTable = ErpProductAddedTable(productId: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundErpProductAddedTable = widget.erpProductAddedTable; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundErpProductAddedTable.productId.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpProductAddedTable.productName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpProductAddedTable.productCategory),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpProductAddedTable.primarySupplier),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
				  ...
				  TextFormField( 
					...
					//em size: Lines : Size: 3, Columns : Display Size: 50 
					      initialValue: getEmStrOpt(foundErpProductAddedTable.productDesc),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					     //IS-FILE STREAM   initialValue: getEmStrOpt(foundErpProductAddedTable.productPicture),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpProductAddedTable.productAddedColumn),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
					   ...
					   productAddedColumn: productAddedColumnVar , 
                          ...
                          await ErpProductAddedTableService.ErpProductAddedTableEdit( 
                                  newErpProductAddedTable.productId, 
                                  newErpProductAddedTable) 
                              .then((message) { 
                                    apiMessage = message; 

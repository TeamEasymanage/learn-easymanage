...
class ErpInventorySumVwForm extends StatefulWidget { 
  const ErpInventorySumVwForm({Key? key}) : super(key: key); 
 
  @override 
  _ErpInventorySumVwFormState createState() => _ErpInventorySumVwFormState(); 
} 
 
class _ErpInventorySumVwFormState extends State<ErpInventorySumVwForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("ErpInventorySumVw Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL   enabled: false,    initialValue: getEmStrOpt(foundRecord.year.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.month.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.totalQty.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
 ...
 // [4] Uncomment For Media Upload Customization. Also Uncomment Media Field Assignment in  newErpInventorySumVw creation below  
 /* 
                          //Get Base64 ready 
 ...
 */ 
 ...
 /* 
                          //Uncomment and Use Model ErpInventorySumVwWoKey from model.dart, when key should not be passed, it is @GeneratedValue on API side  
                          ErpInventorySumVwWoKey newErpInventorySumVw = ErpInventorySumVwWoKey( 
 ...
 */ 
                          ...
                          ErpInventorySumVw newErpInventorySumVw = ErpInventorySumVw( 
					   year: getEmIntStr(yearVar) , 
					   month: getEmIntStrOpt(monthVar) , 
					   totalQty: getEmDoubleStrOpt(totalQtyVar) , 
							  ); 
 
                          await ErpInventorySumVwService.ErpInventorySumVwCreate( 
                                  newErpInventorySumVw.toJson()) 
                              .then((message) { 
                                    apiMessage = message; 

...
class ErpSalesInquiryFilter extends StatefulWidget { 
  const ErpSalesInquiryFilter({Key? key}) : super(key: key); 
 
  @override 
  _ErpSalesInquiryFilterState createState() => _ErpSalesInquiryFilterState(); 
} 
 
class _ErpSalesInquiryFilterState extends State<ErpSalesInquiryFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            ErpSalesInquiryDataTable(viewType: "ListView", 
                                            pageNo: 0, 

...
class ErpInventoryOnlyDd extends StatefulWidget { 
  const ErpInventoryOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _ErpInventoryOnlyDdState createState() => _ErpInventoryOnlyDdState(); 
} 
 
class _ErpInventoryOnlyDdState extends State<ErpInventoryOnlyDd> { 
    ...
    ErpInventoryService.ErpInventoryViewAll( 	
      ...
      setState(() { 	
       erpInventoryList = getList; 	
		invIdSelected = erpInventoryList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //erpInventoryList = erpInventoryList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class ErpInventoryEditDd extends StatefulWidget { 
  ...
  const ErpInventoryEditDd({Key? key, required this.invIdSelected}) : super(key: key); 
...
class _ErpInventoryEditDdRecState extends State<ErpInventoryEditDdRec> { 
  ErpInventory foundErpInventory = ErpInventory(invId: 0 ); 
  ...
  void initState() { 
    ...
    setState(() { 
      foundErpInventory = widget.erpInventory; 
			      _textEditingController3.text = getEmStrOpt(foundErpInventory.invDate); 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundErpInventory.invId.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventory.productId.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController3,  
					    //IS-PICKER  initialValue: getEmStrOpt(foundErpInventory.invDate),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
					   ...
					   invLocation: invLocationVar , 
                          ...
                          await ErpInventoryService.ErpInventoryEdit( 
                                  newErpInventory.invId, 
                                  newErpInventory) 
                              .then((message) { 
                                    apiMessage = message; 

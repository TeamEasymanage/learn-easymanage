...
class ErpProductAddedTableFilter extends StatefulWidget { 
  const ErpProductAddedTableFilter({Key? key}) : super(key: key); 
 
  @override 
  _ErpProductAddedTableFilterState createState() => _ErpProductAddedTableFilterState(); 
} 
 
class _ErpProductAddedTableFilterState extends State<ErpProductAddedTableFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		...
		["Product Name", 'productName', 'CHAR'],  
		["Product Category", 'productCategory', 'CHAR'],  
		["Primary Supplier", 'primarySupplier', 'CHAR'],  
		["Product Desc", 'productDesc', 'TEXT'],  
		//["Product Picture", 'productPicture', 'STREAM'],  
		["Product Added Column", 'productAddedColumn', 'CHAR'],  
	]; 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            ErpProductAddedTableDataTable(viewType: "ListView", 
                                            pageNo: 0, 

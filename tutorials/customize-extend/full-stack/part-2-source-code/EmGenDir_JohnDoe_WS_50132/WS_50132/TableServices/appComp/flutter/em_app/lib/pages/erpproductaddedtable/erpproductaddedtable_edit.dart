...
class ErpProductAddedTableEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int productIdSelected; 
  const ErpProductAddedTableEdit({Key? key, required this.productIdSelected}) : super(key: key); 
 
  @override 
  _ErpProductAddedTableEditState createState() => _ErpProductAddedTableEditState(); 
} 
 
class _ErpProductAddedTableEditState extends State<ErpProductAddedTableEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ErpProductAddedTable Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return ErpProductAddedTableEditRec( 	
...
class ErpProductAddedTableEditRec extends StatefulWidget { 
  final ErpProductAddedTable erpProductAddedTable; 
  const ErpProductAddedTableEditRec({Key? key, required this.erpProductAddedTable}) : super(key: key); 
 
  @override 
  _ErpProductAddedTableEditRecState createState() => _ErpProductAddedTableEditRecState(); 
} 
 
class _ErpProductAddedTableEditRecState extends State<ErpProductAddedTableEditRec> { 

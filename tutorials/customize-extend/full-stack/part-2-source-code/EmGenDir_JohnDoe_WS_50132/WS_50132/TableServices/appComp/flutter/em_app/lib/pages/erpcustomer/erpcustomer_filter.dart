...
class ErpCustomerFilter extends StatefulWidget { 
  const ErpCustomerFilter({Key? key}) : super(key: key); 
 
  @override 
  _ErpCustomerFilterState createState() => _ErpCustomerFilterState(); 
} 
 
class _ErpCustomerFilterState extends State<ErpCustomerFilter> { 
	...
	List<List<String>> tblColumnList = [ 
		["Customer Id", 'customerId', 'CHAR'],  
		["Name", 'name', 'CHAR'],  
		["Phone", 'phone', 'CHAR'],  
		["Mobile Phone", 'mobilePhone', 'CHAR'],  
		//["Pict", 'pict', 'STREAM'],  
		["Email", 'email', 'CHAR'],  
		["Website", 'website', 'CHAR'],  
		["Address", 'address', 'TEXT'],  
		["Dateofinquiry", 'dateofinquiry', 'DATE'],  
		["Requestedqty", 'requestedqty', 'NUMBER'],  
		["Reqquoteamt", 'reqquoteamt', 'FLOAT'],  
		["Meetingpreftime", 'meetingpreftime', 'TIME'],  
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            ErpCustomerDataTable(viewType: "ListView", 
                                            pageNo: 0, 

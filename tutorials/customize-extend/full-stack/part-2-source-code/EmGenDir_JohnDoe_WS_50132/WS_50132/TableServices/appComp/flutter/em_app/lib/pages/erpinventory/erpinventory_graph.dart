...
class ErpInventoryGraph extends StatefulWidget { 	
  const ErpInventoryGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _ErpInventoryGraphState createState() => _ErpInventoryGraphState(); 	
} 	
	 	
class _ErpInventoryGraphState extends State<ErpInventoryGraph> { 	
 	
  //List<ErpInventory> erpInventoryList = []; 	
  List<EmChartModel> erpInventoryList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //ErpInventoryService.ErpInventoryViewAll().then((getList) { 	
    setState(() { 	
      //erpInventoryList = getList; 	
      //Local static data loading 	
      erpInventoryList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'ErpInventory Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                erpInventoryList: erpInventoryList) 	
                            : LineChart(lineChartErpInventory()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartErpInventory() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> erpInventoryList; 	
  const BarChartSample2({Key? key, required this.erpInventoryList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.erpInventoryList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	

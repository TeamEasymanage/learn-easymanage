...
class ErpInventorySumVwFilter extends StatefulWidget { 
  const ErpInventorySumVwFilter({Key? key}) : super(key: key); 
 
  @override 
  _ErpInventorySumVwFilterState createState() => _ErpInventorySumVwFilterState(); 
} 
 
class _ErpInventorySumVwFilterState extends State<ErpInventorySumVwFilter> { 
    ...
    */ 
                                          ...
                                          // ------------ Call Display Data Class with Parameters  
                                           Navigator.of(context).push(MaterialPageRoute( 	  
                                            builder: (context) =>   
                                            ErpInventorySumVwDataTable(viewType: "ListView", 
                                            pageNo: 0, 

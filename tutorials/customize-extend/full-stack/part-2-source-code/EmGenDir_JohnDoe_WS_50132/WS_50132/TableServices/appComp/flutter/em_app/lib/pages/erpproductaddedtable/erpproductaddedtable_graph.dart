...
class ErpProductAddedTableGraph extends StatefulWidget { 	
  const ErpProductAddedTableGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _ErpProductAddedTableGraphState createState() => _ErpProductAddedTableGraphState(); 	
} 	
	 	
class _ErpProductAddedTableGraphState extends State<ErpProductAddedTableGraph> { 	
 	
  //List<ErpProductAddedTable> erpProductAddedTableList = []; 	
  List<EmChartModel> erpProductAddedTableList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    super.initState(); 	
    //ErpProductAddedTableService.ErpProductAddedTableViewAll().then((getList) { 	
    setState(() { 	
      //erpProductAddedTableList = getList; 	
      //Local static data loading 	
      erpProductAddedTableList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'ErpProductAddedTable Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                erpProductAddedTableList: erpProductAddedTableList) 	
                            : LineChart(lineChartErpProductAddedTable()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartErpProductAddedTable() { 	
    ...
    return LineChartData( 	
      ...
      lineBarsData: [ 	
        LineChartBarData( 	
          spots: erpProductAddedTableList 	
              //.sublist(0, 10) 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> erpProductAddedTableList; 	
  const BarChartSample2({Key? key, required this.erpProductAddedTableList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.erpProductAddedTableList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	

...
class ErpInventorySumVwOnlyDd extends StatefulWidget { 
  const ErpInventorySumVwOnlyDd({Key? key}) : super(key: key); 
 
  @override 
  _ErpInventorySumVwOnlyDdState createState() => _ErpInventorySumVwOnlyDdState(); 
} 
 
class _ErpInventorySumVwOnlyDdState extends State<ErpInventorySumVwOnlyDd> { 
    ...
    ErpInventorySumVwService.ErpInventorySumVwViewAll( 	
      ...
      setState(() { 	
       erpInventorySumVwList = getList; 	
		yearSelected = erpInventorySumVwList[0].toListLabVal()[0][1].toString();	
		 //Remove duplicates 	
        //erpInventorySumVwList = erpInventorySumVwList.toSet().toList();	
        _loading = false;	
      });	
    });	
  } 	
...
class ErpInventorySumVwEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int yearSelected; 
  const ErpInventorySumVwEditDd({Key? key, required this.yearSelected}) : super(key: key); 
 
  @override 
  _ErpInventorySumVwEditDdState createState() => _ErpInventorySumVwEditDdState(); 
} 
 
class _ErpInventorySumVwEditDdState extends State<ErpInventorySumVwEditDd> { 
  ...
  void initState() {	
    ...
    ErpInventorySumVwService.ErpInventorySumVwViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
	     backgroundColor: Colors.blue.shade200,	
        appBar: AppBar( 	
          title: const Text("ErpInventorySumVw Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
            ? EmShowProgress(msg: errorMsg)	
                    ...
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<ErpInventorySumVw>( 	
                              future: ErpInventorySumVwService 	
                                      .ErpInventorySumVwQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return ErpInventorySumVwEditDdRec( 	
                                          erpInventorySumVw: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class ErpInventorySumVwEditDdRec extends StatefulWidget { 
  final ErpInventorySumVw erpInventorySumVw; 
  const ErpInventorySumVwEditDdRec({Key? key, required this.erpInventorySumVw}) : super(key: key); 
 
  @override 
  _ErpInventorySumVwEditDdRecState createState() => _ErpInventorySumVwEditDdRecState(); 
} 
 
class _ErpInventorySumVwEditDdRecState extends State<ErpInventorySumVwEditDdRec> { 
  ErpInventorySumVw foundErpInventorySumVw = ErpInventorySumVw(year: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundErpInventorySumVw = widget.erpInventorySumVw; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundErpInventorySumVw.year.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventorySumVw.month.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundErpInventorySumVw.totalQty.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () async { 
					   ...
					   totalQty: getEmDoubleStrOpt(totalQtyVar) , 
                          ...
                          await ErpInventorySumVwService.ErpInventorySumVwEdit( 
                                  newErpInventorySumVw.year, 
                                  newErpInventorySumVw) 
                              .then((message) { 
                                    apiMessage = message; 

...
@Entity 
@Table(name = "erp_product_added_table") 
public class ErpproductaddedtableTblRec { 
	...
	@Column(name = "product_added_column") 
	private String productAddedColumn; 
 
 
public ErpproductaddedtableTblRec() { 
...
public ErpproductaddedtableTblRec(  
 ...
 , String productAddedColumn 
	...
	this.productAddedColumn = productAddedColumn; 
} 
...
public String getProductAddedColumn() { return this.productAddedColumn; } 
...
public void setProductAddedColumn(String productAddedColumn ) { this.productAddedColumn = productAddedColumn; } 
 
 
@Override 
public String toString() { 
	return "ErpproductaddedtableTblRec [ productId = "+this.productId+" ]"; 
} 

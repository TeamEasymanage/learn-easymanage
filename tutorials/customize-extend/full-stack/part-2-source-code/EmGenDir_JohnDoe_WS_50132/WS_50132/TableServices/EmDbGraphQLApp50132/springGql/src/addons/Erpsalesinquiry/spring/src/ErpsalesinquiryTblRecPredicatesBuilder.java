...
public final class ErpsalesinquiryTblRecPredicatesBuilder { 
 
    EmPredicatesBuilder emBuilder = new EmPredicatesBuilder(); 
 
    public ErpsalesinquiryTblRecPredicatesBuilder (String search) { 
        if (search != null) { 
    ...
    public BooleanExpression build() { 
        ...
        while (param.hasNext()) 
        { 
            ErpsalesinquiryTblRecPredicate predicate = new ErpsalesinquiryTblRecPredicate(param.next()); 
